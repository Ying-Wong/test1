...
# 文件路径
depth_image_path = "ProcessedFrames/607/Depth_1719406077238_4.png"  # 替换为你的深度图像路径
color_image_path = "color_image.png"  # 替换为你的彩色图像路径
...
# 生成点云并转换
point_cloud = depth_to_point_cloud(depth_image.astype(np.float32) * (depth_image.max() / 255.0), ir_intrinsics)
...
# save_point_cloud_to_ply(transformed_points_filtered, colors_filtered, 'segmented_point_cloud.ply')
